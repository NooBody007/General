function [MOVINGREG] = registerMarsImage2(MOVING,FIXED)
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',756.250000,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',756.250000,'NumOctaves',2,'NumScaleLevels',4);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',43.750000,'MaxRatio',0.437500);
